                    ...
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner js-fullheight">
                        <div className="desc">
                          ...
                          <p><a className="btn btn-primary btn-learn" href="CV_LawrenceShen_202307.pdf" target="_blank" rel="noopener noreferrer" style={{color: "#fff", border: "1px solid #fff", textShadow: "1px 1px 2px grey", boxShadow: "1px 1px 2px grey"}}><b>View CV </b><i className="icon-download4" /></a></p>
                        </div>
                      </div>
                    </div>
                  </div>
